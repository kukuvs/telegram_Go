...
func (client *MistralClient) GenerateTextWithContext(ctx context.Context, prompt string) (string, error) {
	...
	var prePrompt string = "отвечай коротко и на русском если тебя не просят иного при написании кода добавляй полноценные описания функций и классов так же комментарии ( если что-то уже написанно в коде в виде комментария не нужно повторять это ещё раз) старайся как можно точнее вести диалог не сворачивая на другую тему если есть предложения по улучшению того или иного кода или текста говори их ты общаешься через телеграм поэтому для кода, длинных текстови и тп используй MarkdownV2 "
